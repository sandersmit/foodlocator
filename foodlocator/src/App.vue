              ...
              <v-responsive width="450">
                <v-form @submit.prevent>
                  <v-container>
                    ...
                    <v-row>
                      <v-col cols="12" md="12">
                        <v-autocomplete clearable label="Search country" :items="computeCountryNames"
                          v-model="searchedCountry"></v-autocomplete>
                      </v-col>
                      <v-col cols="12" md="12">
              ...
              <v-responsive width="450">
                ...
                <ul>
                  ...
                  <li class="my-3 text-blue-darken-1" v-else>
                    ...
                    <span v-else-if="!showloader">{{ computeCountryFood.length < 1 ? `no food found` : "no selection"
                        }}</span>
                  </li>
                </ul>
                <p class="mt-5">
          ...
          <v-col>
            <v-responsive> 
              <div class="countriesTop">
                ...
                <a href="" @click.prevent="scrollPageTo(400)" v-if="!locationUser" class="text-warning my-3 ">Confirm
                  user location</a>
          ...
          <v-row justify="space-around">
            ...
            <v-col cols="auto">
              <v-responsive width="450">
                ...
                <v-btn class="mt-6" href="#html" @click="fetchCountriePosition(dataFindSelected.currentLandOrigin)">
                  {{ "show on map" }}
                </v-btn>
              </v-responsive>
            </v-col>
              ...
              <v-col cols="auto">
                <v-responsive width="450">
                  <h2 class="text-h4">
                    ...
                    <span v-if="pages!=1" class="text-blue-darken-1">{{ pages }}</span>
